					...
					<div className="max-w-7xl mx-auto">
						<Reveal from="bottom">
							...
							<p className="text-gray-600 text-center max-w-2xl mx-auto mb-12 text-lg">
								Whether you're ready to start your driving
								journey or have questions about our lessons,
								we're here to help. Contact us today and take
								the first step towards becoming a confident
								driver.
							</p>
						</Reveal>
